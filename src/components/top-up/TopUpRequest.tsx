          ...
          <div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="coin" className="block text-sm font-semibold text-gray-900 mb-3">
                ...
                <div>
                  <label htmlFor="network" className="block text-sm font-semibold text-gray-900 mb-3">
              ...
              {/* Wallet Address */}
              <div>
                <label htmlFor="walletAddress" className="block text-sm font-semibold text-gray-900 mb-3">
              ...
              <div>
                <label htmlFor="confirmAddress" className="block text-sm font-semibold text-gray-900 mb-3">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{formatAUD(formData.amount)}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="text-sm text-gray-900">~{formatCrypto(fees.networkFee)} {String(formData.coin)}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center py-2 bg-white rounded-lg px-3 py-3">
                      ...
                      <div className="text-right">
                        <span className="text-lg font-bold text-blue-600">{formatCrypto(fees.totalReceive)} {String(formData.coin)}</span>
