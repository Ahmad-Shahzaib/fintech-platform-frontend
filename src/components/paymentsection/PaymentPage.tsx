      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-gray-600">Please fill in your payment details to complete the transaction</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              {paymentMethod === 'bank_transfer' && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Bank <span className="text-red-500">*</span></label>
                  <select
                    value={bankType}
              ...
              <div>
                ...
                <div className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition">
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex items-center justify-center mt-3 text-sm text-gray-500">
                      ...
                      <span>{fileRef.current?.files?.[0]?.name || 'No file selected'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full bg-blue-600 text-white font-semibold py-4 rounded-lg hover:bg-blue-700 transition duration-200 shadow-md text-lg disabled:opacity-60"
                >
                  {submitState?.loading ? 'Submitting...' : 'Submit Payment Confirmation'}
                </button>
              </div>
