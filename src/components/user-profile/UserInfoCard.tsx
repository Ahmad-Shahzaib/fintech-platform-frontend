  ...
  const renderError = () => {
    ...
    return (
      <div className="mb-4 p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg">
        ...
        <p className="text-xs mt-1">Please check if you're logged in and the API is accessible.</p>
        <button
  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 lg:mb-6">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {loading ? 'Loading...' : (userProfile?.name || 'Not available')}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {loading ? 'Loading...' : (userProfile?.email || 'Not available')}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {loading ? 'Loading...' : (userProfile?.phone || 'Not available')}
              </p>
            </div>
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4 shadow-2xl">
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col">
            <div className="custom-scrollbar  overflow-y-auto px-2 pb-3">
              <div>
                <h2 className="mb-5 text-lg font-medium text-gray-800 dark:text-white/90 lg:mb-6">
                  Personal Information
                </h2>
