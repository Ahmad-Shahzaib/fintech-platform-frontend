...
import { submitTicket } from '@/redux/thunk/submitTicketThunk';
import { resetSubmitTicket } from '@/redux/slice/submitTicketSlice';
import { RootState, AppDispatch } from '@/redux/store';

const SupportPage = () => {
  const dispatch = useDispatch<AppDispatch>();
  const { loading: isSubmitting, success: submitSuccess, error: submitError } = useSelector(
    (state: RootState) => state.submitTicket
  );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Dispatch the thunk with form data
    ...
    if (result.type === submitTicket.fulfilled.type) {
      setFormData({
        name: '',
        email: '',
        subject: '',
  ...
  return (
    <div className="">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <Link
          href="/support"
          className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium mb-8 transition-colors"
        >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6">Submit Your Issue</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full text-sm text-gray-600 dark:text-gray-400 file:bg-blue-600 dark:file:bg-blue-700 file:text-white file:px-4 file:py-2 file:rounded file:border-0 file:cursor-pointer"
                accept="image/*,.pdf,.doc,.docx,.txt"
              />
              {formData.attachment && (
                <p className="mt-2 text-sm text-gray-700 dark:text-gray-400">Selected file: {formData.attachment.name}</p>
              )}
            </div>
        ...
        <div className="mt-8 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6">
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">Other Ways to Get Help</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-800 dark:text-white">Email Support</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Mon-Fri, 9AM-5PM EST</p>
              </div>
            </div>
            ...
            <div className="flex items-center p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-800 dark:text-white">Phone Support</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">+92 315 1012287</p>
              </div>
            </div>
          </div>
        </div>
