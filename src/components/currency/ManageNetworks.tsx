...
const ManageNetworks = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Manage Networks</h1>
                        ...
                        {loading ? (
                            ...
                            networks.map((network: Network) => (
                                <tr key={network.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm font-medium text-gray-900 dark:text-white">{network.code}</div>
                                    </td>
